...
var _MergePersonDealRelatedInfo = _interopRequireDefault(require("./MergePersonDealRelatedInfo"));

var _PersonNameCountAndEmailInfoWithIds = _interopRequireDefault(require("./PersonNameCountAndEmailInfoWithIds"));
 ...
 * @version 1.0.0
 */
var AdditionalMergePersonInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function AdditionalMergePersonInfo() {
    (0, _classCallCheck2["default"])(this, AdditionalMergePersonInfo);

    _PersonNameCountAndEmailInfoWithIds["default"].initialize(this);

    _MergePersonDealRelatedInfo["default"].initialize(this);
  ...
  (0, _createClass2["default"])(AdditionalMergePersonInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _PersonNameCountAndEmailInfoWithIds["default"].constructFromObject(data, obj);

        _MergePersonDealRelatedInfo["default"].constructFromObject(data, obj);
  ...
  return AdditionalMergePersonInfo;
}();
/**
...
_PersonNameCountAndEmailInfoWithIds["default"].prototype['owner_id'] = undefined;
/**
 * The ID of the organization related to the person
 * @member {Number} org_id
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['org_id'] = undefined;
/**
 * The ID of the person with what the main person was merged
 * @member {Number} merge_what_id
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['merge_what_id'] = undefined;
/**
 * The name of the person
 * @member {String} name
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['name'] = undefined;
/**
 * The first name of the person
 * @member {String} first_name
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['first_name'] = undefined;
/**
 * The last name of the person
 * @member {String} last_name
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['last_name'] = undefined;
/**
 * The count of email messages related to the person
 * @member {Number} email_messages_count
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['email_messages_count'] = undefined;
/**
 * The count of activities related to the person
 * @member {Number} activities_count
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['activities_count'] = undefined;
/**
 * The count of done activities related to the person
 * @member {Number} done_activities_count
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['done_activities_count'] = undefined;
/**
 * The count of undone activities related to the person
 * @member {Number} undone_activities_count
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['undone_activities_count'] = undefined;
/**
 * The count of files related to the person
 * @member {Number} files_count
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['files_count'] = undefined;
/**
 * The count of notes related to the person
 * @member {Number} notes_count
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['notes_count'] = undefined;
/**
 * The count of followers related to the person
 * @member {Number} followers_count
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['followers_count'] = undefined;
/**
 * The date and time of the last incoming email associated with the person
 * @member {String} last_incoming_mail_time
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['last_incoming_mail_time'] = undefined;
/**
 * The date and time of the last outgoing email associated with the person
 * @member {String} last_outgoing_mail_time
 */

_PersonNameCountAndEmailInfoWithIds["default"].prototype['last_outgoing_mail_time'] = undefined; // Implement MergePersonDealRelatedInfo interface:
...
_MergePersonDealRelatedInfo["default"].prototype['open_deals_count'] = undefined;
/**
 * The count of related open deals related with the item
 * @member {Number} related_open_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['related_open_deals_count'] = undefined;
/**
 * The count of closed deals related with the item
 * @member {Number} closed_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['closed_deals_count'] = undefined;
/**
 * The count of related closed deals related with the item
 * @member {Number} related_closed_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['related_closed_deals_count'] = undefined;
/**
 * The count of won deals related with the item
 * @member {Number} won_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['won_deals_count'] = undefined;
/**
 * The count of related won deals related with the item
 * @member {Number} related_won_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['related_won_deals_count'] = undefined;
/**
 * The count of lost deals related with the item
 * @member {Number} lost_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['lost_deals_count'] = undefined;
/**
 * The count of related lost deals related with the item
 * @member {Number} related_lost_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['related_lost_deals_count'] = undefined;
/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */

_MergePersonDealRelatedInfo["default"].prototype['next_activity_date'] = undefined;
/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */

_MergePersonDealRelatedInfo["default"].prototype['next_activity_time'] = undefined;
/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */

_MergePersonDealRelatedInfo["default"].prototype['next_activity_id'] = undefined;
/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */

_MergePersonDealRelatedInfo["default"].prototype['last_activity_id'] = undefined;
/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */

_MergePersonDealRelatedInfo["default"].prototype['last_activity_date'] = undefined;
/**
 * The count of open participant deals related with the item
 * @member {Number} participant_open_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['participant_open_deals_count'] = undefined;
/**
 * The count of closed participant deals related with the item
 * @member {Number} participant_closed_deals_count
 */

_MergePersonDealRelatedInfo["default"].prototype['participant_closed_deals_count'] = undefined;
var _default = AdditionalMergePersonInfo;
