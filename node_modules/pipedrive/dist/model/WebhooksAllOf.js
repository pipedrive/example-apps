 ...
 * @version 1.0.0
 */
var WebhooksAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WebhooksAllOf</code>.
   * @alias module:model/WebhooksAllOf
   */
  function WebhooksAllOf() {
    (0, _classCallCheck2["default"])(this, WebhooksAllOf);
  ...
  (0, _createClass2["default"])(WebhooksAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_BaseWebhook["default"]]);
          delete data['data'];
        }
