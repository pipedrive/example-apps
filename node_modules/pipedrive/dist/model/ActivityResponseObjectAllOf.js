    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('location_lat')) {
          obj['location_lat'] = _ApiClient["default"].convertToType(data['location_lat'], 'Number');
          delete data['location_lat'];
        }

        if (data.hasOwnProperty('location_long')) {
          obj['location_long'] = _ApiClient["default"].convertToType(data['location_long'], 'Number');
