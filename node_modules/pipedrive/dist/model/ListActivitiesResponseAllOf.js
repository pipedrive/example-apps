...
var _ActivityDistributionDataWithAdditionalData = _interopRequireDefault(require("./ActivityDistributionDataWithAdditionalData"));
 ...
 * @version 1.0.0
 */
var ListActivitiesResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListActivitiesResponseAllOf</code>.
   * @alias module:model/ListActivitiesResponseAllOf
   */
  function ListActivitiesResponseAllOf() {
    (0, _classCallCheck2["default"])(this, ListActivitiesResponseAllOf);
  ...
  (0, _createClass2["default"])(ListActivitiesResponseAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('additional_data')) {
          obj['additional_data'] = _ActivityDistributionDataWithAdditionalData["default"].constructFromObject(data['additional_data']);
  ...
  return ListActivitiesResponseAllOf;
}();
/**
...
var _default = ListActivitiesResponseAllOf;
