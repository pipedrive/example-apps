 ...
 * @version 1.0.0
 */
var NoteFieldsResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NoteFieldsResponseAllOf</code>.
   * @alias module:model/NoteFieldsResponseAllOf
   */
  function NoteFieldsResponseAllOf() {
    (0, _classCallCheck2["default"])(this, NoteFieldsResponseAllOf);
  ...
  (0, _createClass2["default"])(NoteFieldsResponseAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_NoteField["default"]]);
          delete data['data'];
        }
...
var _default = NoteFieldsResponseAllOf;
