 ...
 * @version 1.0.0
 */
var ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities = /*#__PURE__*/function () {
  /**
   ...
   */
  function ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities() {
    (0, _classCallCheck2["default"])(this, ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities);
  ...
  (0, _createClass2["default"])(ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ACTIVITY_TYPE_NAME')) {
          obj['ACTIVITY_TYPE_NAME'] = _ApiClient["default"].convertToType(data['ACTIVITY_TYPE_NAME'], 'Number');
  ...
  return ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities;
}();
/**
...
var _default = ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities;
