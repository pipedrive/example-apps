...
var _DeleteProductFollowerResponseData = _interopRequireDefault(require("./DeleteProductFollowerResponseData"));
 ...
 * @version 1.0.0
 */
var DeleteProductFollowerResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DeleteProductFollowerResponse</code>.
   * @alias module:model/DeleteProductFollowerResponse
   */
  function DeleteProductFollowerResponse() {
    (0, _classCallCheck2["default"])(this, DeleteProductFollowerResponse);
  ...
  (0, _createClass2["default"])(DeleteProductFollowerResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DeleteProductFollowerResponseData["default"].constructFromObject(data['data']);
          delete data['data'];
        }
...
var _default = DeleteProductFollowerResponse;
