 ...
 * @version 1.0.0
 */
var DealSummaryPerCurrency = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DealSummaryPerCurrency</code>.
   * The currency count summary
   * @alias module:model/DealSummaryPerCurrency
   */
  function DealSummaryPerCurrency() {
    (0, _classCallCheck2["default"])(this, DealSummaryPerCurrency);
  ...
  (0, _createClass2["default"])(DealSummaryPerCurrency, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('CURRENCY_ID')) {
          obj['CURRENCY_ID'] = _ApiClient["default"].convertToType(data['CURRENCY_ID'], 'Number');
...
var _default = DealSummaryPerCurrency;
