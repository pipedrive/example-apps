...
var _RelatedDealDataDEALID = _interopRequireDefault(require("./RelatedDealDataDEALID"));
 ...
 * @version 1.0.0
 */
var RelatedDealData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RelatedDealData</code>.
   * @alias module:model/RelatedDealData
   */
  function RelatedDealData() {
    (0, _classCallCheck2["default"])(this, RelatedDealData);
  ...
  (0, _createClass2["default"])(RelatedDealData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('DEAL_ID')) {
          obj['DEAL_ID'] = _RelatedDealDataDEALID["default"].constructFromObject(data['DEAL_ID']);
          delete data['DEAL_ID'];
        }
