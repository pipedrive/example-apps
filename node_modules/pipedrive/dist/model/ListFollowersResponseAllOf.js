...
var _ListFollowersResponseAllOfData = _interopRequireDefault(require("./ListFollowersResponseAllOfData"));
 ...
 * @version 1.0.0
 */
var ListFollowersResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListFollowersResponseAllOf</code>.
   * @alias module:model/ListFollowersResponseAllOf
   */
  function ListFollowersResponseAllOf() {
    (0, _classCallCheck2["default"])(this, ListFollowersResponseAllOf);
  ...
  (0, _createClass2["default"])(ListFollowersResponseAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_ListFollowersResponseAllOfData["default"]]);
          delete data['data'];
        }
  ...
  return ListFollowersResponseAllOf;
}();
/**
...
var _default = ListFollowersResponseAllOf;
