...
var _OrganizationsMergeResponseData = _interopRequireDefault(require("./OrganizationsMergeResponseData"));
 ...
 * @version 1.0.0
 */
var OrganizationsMergeResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrganizationsMergeResponse</code>.
   * @alias module:model/OrganizationsMergeResponse
   */
  function OrganizationsMergeResponse() {
    (0, _classCallCheck2["default"])(this, OrganizationsMergeResponse);
  ...
  (0, _createClass2["default"])(OrganizationsMergeResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _OrganizationsMergeResponseData["default"].constructFromObject(data['data']);
          delete data['data'];
        }
  ...
  return OrganizationsMergeResponse;
}();
/**
...
var _default = OrganizationsMergeResponse;
