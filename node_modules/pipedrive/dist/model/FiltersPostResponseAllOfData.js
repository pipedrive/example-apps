 ...
 * @version 1.0.0
 */
var FiltersPostResponseAllOfData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FiltersPostResponseAllOfData</code>.
   * @alias module:model/FiltersPostResponseAllOfData
   */
  function FiltersPostResponseAllOfData() {
    (0, _classCallCheck2["default"])(this, FiltersPostResponseAllOfData);
  ...
  (0, _createClass2["default"])(FiltersPostResponseAllOfData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('temporary_flag')) {
          obj['temporary_flag'] = _ApiClient["default"].convertToType(data['temporary_flag'], 'Boolean');
        ...
        if (data.hasOwnProperty('custom_view_id')) {
          obj['custom_view_id'] = _ApiClient["default"].convertToType(data['custom_view_id'], 'Number');
  ...
  return FiltersPostResponseAllOfData;
}();
/**
...
var _default = FiltersPostResponseAllOfData;
