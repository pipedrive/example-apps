...
var _ListMailMessagesResponseAllOfData = _interopRequireDefault(require("./ListMailMessagesResponseAllOfData"));
 ...
 * @version 1.0.0
 */
var ListMailMessagesResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListMailMessagesResponseAllOf</code>.
   * @alias module:model/ListMailMessagesResponseAllOf
   */
  function ListMailMessagesResponseAllOf() {
    (0, _classCallCheck2["default"])(this, ListMailMessagesResponseAllOf);
  ...
  (0, _createClass2["default"])(ListMailMessagesResponseAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_ListMailMessagesResponseAllOfData["default"]]);
          delete data['data'];
        }
  ...
  return ListMailMessagesResponseAllOf;
}();
/**
...
var _default = ListMailMessagesResponseAllOf;
