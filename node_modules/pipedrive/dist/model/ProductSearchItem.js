...
var _ProductSearchItemItem = _interopRequireDefault(require("./ProductSearchItemItem"));
...
var ProductSearchItem = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ProductSearchItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _ProductSearchItemItem["default"].constructFromObject(data['item']);
          delete data['item'];
        }
...
var _default = ProductSearchItem;
