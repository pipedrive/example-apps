  ...
  */
  ...
  (0, _createClass2["default"])(DealsApi, [{
    ...
    value: function addDealFollowerWithHttpInfo(id, opts) {
      opts = opts || {};
      var postBody = opts['addDealFollowerRequest']; // verify the required parameter 'id' is set
    ...
    value: function addDealParticipantWithHttpInfo(id, opts) {
      opts = opts || {};
      var postBody = opts['addDealParticipantRequest']; // verify the required parameter 'id' is set
    ...
    value: function addDealProductWithHttpInfo(id, opts) {
      opts = opts || {};
      var postBody = opts['newDealProduct']; // verify the required parameter 'id' is set
    ...
    value: function mergeDealsWithHttpInfo(id, opts) {
      opts = opts || {};
      var postBody = opts['mergeDealsRequest']; // verify the required parameter 'id' is set
    ...
    value: function updateDealProductWithHttpInfo(id, productAttachmentId, opts) {
      opts = opts || {};
      var postBody = opts['basicDealProduct']; // verify the required parameter 'id' is set
